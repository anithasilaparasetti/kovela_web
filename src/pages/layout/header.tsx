...
const HeaderComponent: FC<HeaderProps> = ({ collapsed, toggle }) => {
  ...
  return (
    <Header className="layout-page-header bg-2" style={{ backgroundColor: '#FFA001' }}>
      {device !== 'MOBILE' && (
        <div className="logo" style={{ width: collapsed ? 80 : 80 }}>
          <img
            src={
              'http://res.cloudinary.com/df9fghp1d/image/upload/v1690743662/cannabis2connect/patient/Kovela-logo.png.png'
            }
            style={{
              marginRight: '20px',
              width: '150px',
