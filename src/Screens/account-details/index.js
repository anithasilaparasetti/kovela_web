                    ...
                    <div className="middle-wrap">
                        <div className="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div className="card-body p-4 w-100 bg-current border-0 d-flex rounded-3">
                                <a href="default-settings.html" className="d-inline-block mt-2"><i className="ti-arrow-left font-sm text-white"></i></a>
                                <h4 className="font-xs text-white fw-600 ms-4 mb-0 mt-2">Account Details</h4>
                            </div>
                            <div className="card-body p-lg-5 p-4 w-100 border-0 ">
                            <div className="row justify-content-center">
                                <div className="col-lg-4 text-center">
                                    <figure className="avatar ms-auto me-auto mb-0 mt-2 w100"><img src="https://media1.giphy.com/media/h1j2W6Wy8sZUJCY0VY/giphy.gif?cid=ecf05e47uq55fp3yfydtdzx4u9f3krydgyxi730vwab3bvpj&ep=v1_gifs_search&rid=giphy.gif&ct=g"  className="shadow-sm rounded-3 w-50"/></figure>
                                    <h2 className="fw-700 font-sm text-grey-900 mt-3">Jai Shree ram</h2>
                                    <h4 className="text-grey-500 fw-500 mb-3 font-xsss mb-4">India</h4>    
