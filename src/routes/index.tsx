...
const Customer = lazy(() => import(/* webpackChunkName: "customer'"*/ '@/pages/customer'));
...
const routeList: RouteObject[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'profile',
        element: <WrapperRouteComponent element={<Profile />} titleId="title.profile" />,
      },
      {
        path: 'customer',
        element: <WrapperRouteComponent element={<Customer />} titleId="title.customer" />,
      },
      {
        path: 'component/form',
